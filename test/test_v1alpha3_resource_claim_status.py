...
from kubernetes.client.models.v1alpha3_resource_claim_status import V1alpha3ResourceClaimStatus  # noqa: E501
...
class TestV1alpha3ResourceClaimStatus(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes.client.models.v1alpha3_resource_claim_status.V1alpha3ResourceClaimStatus()  # noqa: E501
        if include_optional :
