...
from kubernetes.client.models.v1alpha3_device_allocation_result import V1alpha3DeviceAllocationResult  # noqa: E501
...
class TestV1alpha3DeviceAllocationResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes.client.models.v1alpha3_device_allocation_result.V1alpha3DeviceAllocationResult()  # noqa: E501
        if include_optional :
