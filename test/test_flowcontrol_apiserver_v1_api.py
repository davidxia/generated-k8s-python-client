...
from kubernetes.client.api.flowcontrol_apiserver_v1_api import FlowcontrolApiserverV1Api  # noqa: E501
...
class TestFlowcontrolApiserverV1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.flowcontrol_apiserver_v1_api.FlowcontrolApiserverV1Api()  # noqa: E501
