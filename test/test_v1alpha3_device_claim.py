...
from kubernetes.client.models.v1alpha3_device_claim import V1alpha3DeviceClaim  # noqa: E501
...
class TestV1alpha3DeviceClaim(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes.client.models.v1alpha3_device_claim.V1alpha3DeviceClaim()  # noqa: E501
        if include_optional :
