...
from kubernetes.client.models.v1alpha3_opaque_device_configuration import V1alpha3OpaqueDeviceConfiguration  # noqa: E501
...
class TestV1alpha3OpaqueDeviceConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = kubernetes.client.models.v1alpha3_opaque_device_configuration.V1alpha3OpaqueDeviceConfiguration()  # noqa: E501
        if include_optional :
