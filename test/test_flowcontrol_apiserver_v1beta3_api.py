...
from kubernetes.client.api.flowcontrol_apiserver_v1beta3_api import FlowcontrolApiserverV1beta3Api  # noqa: E501
...
class TestFlowcontrolApiserverV1beta3Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.flowcontrol_apiserver_v1beta3_api.FlowcontrolApiserverV1beta3Api()  # noqa: E501
