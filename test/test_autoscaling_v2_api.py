...
from kubernetes.client.api.autoscaling_v2_api import AutoscalingV2Api  # noqa: E501
...
class TestAutoscalingV2Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.autoscaling_v2_api.AutoscalingV2Api()  # noqa: E501
