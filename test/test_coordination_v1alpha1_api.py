...
from kubernetes.client.api.coordination_v1alpha1_api import CoordinationV1alpha1Api  # noqa: E501
...
class TestCoordinationV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = kubernetes.client.api.coordination_v1alpha1_api.CoordinationV1alpha1Api()  # noqa: E501
